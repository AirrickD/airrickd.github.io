        ...
        var e = new function() {
            this.cookiesAccepted = null,
                ...
                this.setStatus = function(e) {
                    ...
                    var n = new Date,
                        i = new Date;
                    "accept" === e ? (e = "true", i.setTime(parseInt(n.getTime()) + 1e3 * parseInt(cnArgs.cookieTime))) : (e = "false", i.setTime(parseInt(n.getTime()) + 1e3 * parseInt(cnArgs.cookieTimeRejected))),
                        r.cookie = cnArgs.cookieName + "=" + e + ";expires=" + i.toUTCString() + ";" + (cnArgs.cookieDomain ? "domain=" + cnArgs.cookieDomain + ";" : "") + (cnArgs.cookiePath ? "path=" + cnArgs.cookiePath + ";" : "") + ("1" === cnArgs.secure ? "secure;" : ""),
                ...
                this.adjustOffset = function() {
                    var e = r.getElementById("coronabar"),
                        ...
                        n = 0,
                        i = 0;
                    "top" === cnArgs.position && null !== t && (i = t.offsetHeight, this.noticeContainer.style.top = i + "px"),
                    null !== e && (n = e.offsetHeight - 1, "top" === cnArgs.position ? (e.style.top = i + "px", this.noticeContainer.style.top = n + i + "px") : this.noticeContainer.style.bottom = n + "px")
                },
                ...
                this.init = function() {
                    ...
                    "1" === cnArgs.coronabarActive && (r.addEventListener("display.coronabar", function(e) {
                        ...
                        if (null !== t) {
                            ...
                            n.open("POST", cnArgs.ajaxUrl, !0),
                                ...
                                n.onerror = function() {},
                                n.send("action=cn_save_cases&nonce=" + cnArgs.nonce + "&data=" + JSON.stringify(t))
                        }
                    })),
                    ...
                    for (o = 0; o < n.length; o++)
                        n[o].addEventListener("click", function(e) {
                            e.preventDefault(),
                                t.noticeContainer.classList.contains("cookie-revoke-visible") ? (t.hideRevokeNotice(), t.noticeContainer.addEventListener("animationend", function e() {
                                    t.noticeContainer.removeEventListener("animationend", e),
                                        t.showCookieNotice()
