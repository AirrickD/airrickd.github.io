...
var twemoji = function() {
    ...
    var f = {
            ...
            className: "emoji",
            convert: {
                fromCodePoint: function(d) {/*! This file is auto-generated */
                ...
                return ("string" == typeof d ? function(d, a) {
                    return o(d, function(d) {
                        var u,
                            ...
                            b = a.callback(e, a);
                        if (e && b) {
                            for (f in c = "<img ".concat('class="', a.className, '" ', 'draggable="false" ', 'alt="', d, '"', ' src="', b, '"'), u = a.attributes(d, e))
                    ...
                    for (; p--;) {
                        for (e = !1, b = document.createDocumentFragment(), a = l[p], t = a.nodeValue, n = 0; o = m.exec(t);) {
                            if ((s = o.index) !== n && b.appendChild(g(t.slice(n, s), !0)), o = o[0], i = x(o), n = s + o.length, s = u.callback(i, u), i && s) {
                                for (c in (r = new Image).onerror = u.onerror, r.setAttribute("draggable", "false"), f = u.attributes(o, i))
    ...
    function i(d, u) {
        for (var f = [], c = 0, e = 0, b = 0; b < d.length;)
            c = d.charCodeAt(b++),
                e ? (f.push((65536 + (e - 55296 << 10) + (c - 56320)).toString(16)), e = 0) : 55296 <= c && c <= 56319 ? e = c : f.push(c.toString(16));
        return f.join(u || "-")
    }
}();
    ...
    c.wp = c.wp || {},
        c.wp.emoji = new function() {
            ...
            function s() {
                if (!t) {
                    if (void 0 === c.twemoji)
                        return 600 < r ? void 0 : (c.clearTimeout(u), u = c.setTimeout(s, 50), void r++);
                    n = c.twemoji,
                        t = !0,
                    e && new e(function(u) {
                        for (var e, t, n, a, r = u.length; r--;) {
                            if (e = u[r].addedNodes, t = u[r].removedNodes, 1 === (n = e.length) && 1 === t.length && 3 === e[0].nodeType && "IMG" === t[0].nodeName && e[0].data === t[0].alt && "load-failed" === t[0].getAttribute("data-error"))
                                return;
                            for (; n--;) {
                                if (3 === (a = e[n]).nodeType) {
                                    if (!a.parentNode)
